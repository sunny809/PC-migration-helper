...
| ID | 任务 | 说明 | 优先级 | 估时 |
|----|------|------|--------|------|
| ENGiN-1 | **README 英文版** + 截图 + 徽章 | GitHub 项目品牌，第一印象 | 🔴 P1 | 1天 |
...
|----|------|---------------|--------|------|
| UI-13 | **Treemap 容量热图** — 方块图替代条形图，显示目录大小权重 | 🔴 用户需要直观看到"哪个目录占空间最大"来决策要不要迁移 | 🔴 P1 | 3天 |
| UI-2 | **theme.qss 现代化重写** — 统一色板、干净卡片、合理间距 | 🔴 当前 QSS 颜色生硬，无层次感，影响第一印象 | 🔴 P1 | 2天 |
